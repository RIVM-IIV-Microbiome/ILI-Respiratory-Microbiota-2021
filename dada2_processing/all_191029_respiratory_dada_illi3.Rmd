...
path <- "all_191029/" # CHANGE ME to the directory containing the fastq files after unzipping.
...
# Check
head(out)
write.table(out,"all_191029/filter_trim_out.txt")
```
...
saveRDS(seqtab.nochim, "all_191029/seqtab.nochim_all_191029.rds")
...
write.table(track, row.names = TRUE, col.names = NA, "all_191029/Tract table_all190524.txt", sep = "\t")
```
...
# ASV data
write.table(seqtab.nochim, row.names = TRUE, col.names = NA, "all_191029/all_191029_sequences.txt", sep = "\t") 
#change directory to where you want to store your data

write.table(taxa, row.names = TRUE, col.names = NA, "all_191029/all_191029_taxonomy.txt", sep = "\t") 
#change directory to where you want to store your data
```
