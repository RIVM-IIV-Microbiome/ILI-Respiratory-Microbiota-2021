...
# ASV data
write.table(seqtab.nochim, row.names = TRUE, col.names = NA, "all_191021/all_191021_sequences.txt", sep = "\t") 
#change directory to where you want to store your data

write.table(taxa, row.names = TRUE, col.names = NA, "all_191021/all_191021_taxonomy.txt", sep = "\t") 
#change directory to where you want to store your data
```
