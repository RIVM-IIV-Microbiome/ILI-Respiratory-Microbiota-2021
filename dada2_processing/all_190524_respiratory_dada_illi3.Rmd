...
path <- "all_190524/" # CHANGE ME to the directory containing the fastq files after unzipping.
...
# Check
head(out)
write.table(out,"all_190524/filter_trim_out.txt")
```
...
saveRDS(seqtab.nochim, "all_190524/seqtab.nochim_all_190524.rds")
...
write.table(track, row.names = TRUE, col.names = NA, "all_190524/Tract table_all190524.txt", sep = "\t")
```
...
taxa <- taxid
head(taxa)
saveRDS(taxa, "all_190524/all_190524_taxa.rds")
# Check
...
# ASV data
write.table(seqtab.nochim, row.names = TRUE, col.names = NA, "all_190524/all_190524_sequences.txt", sep = "\t") 
#change directory to where you want to store your data

write.table(taxa, row.names = TRUE, col.names = NA, "all_190524/all_190524_taxonomy.txt", sep = "\t") 
#change directory to where you want to store your data
```
