...
path <- "all_191118/" # CHANGE ME to the directory containing the fastq files after unzipping.
...
# Check
head(out)
write.table(out,"all_191118/filter_trim_out.txt")
```
...
saveRDS(seqtab.nochim, "all_191118/seqtab.nochim_all_191118.rds")
...
write.table(track, row.names = TRUE, col.names = NA, "all_191118/Tract table_all190524.txt", sep = "\t")
```
...
# ASV data
write.table(seqtab.nochim, row.names = TRUE, col.names = NA, "all_191118/all_191118_sequences.txt", sep = "\t") 
#change directory to where you want to store your data

write.table(taxa, row.names = TRUE, col.names = NA, "all_191118/all_191118_taxonomy.txt", sep = "\t") 
#change directory to where you want to store your data
```
