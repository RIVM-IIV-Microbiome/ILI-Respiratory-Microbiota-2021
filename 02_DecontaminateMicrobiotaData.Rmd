...
07] Total number of reads = 27095780
08] Average number of reads = 25394.36
09] Median number of reads = 25097
10] Sparsity = 0.98614530685565
11] Number of singletons = 44
12] % of taxa that are singletons 
  (i.e. exactly one read detected across all samples) = 0.42  
